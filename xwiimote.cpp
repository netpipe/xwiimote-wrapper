...
void xwii::print_info(const char *format, ...)
{
	va_list list;
	char str[58 + 1];
...
void xwii::print_error(const char *format, ...)
{
	va_list list;
	char str[58 + 80 + 1];
...
void xwii::key_show(const struct xwii_event *event)
{
...
void xwii::accel_show_ext_x(double val)
{
	if (val < -10)
		mvprintw(6, 81, "<=========##          ");
	else if (val < -9)
...
void xwii::accel_show_ext_y(double val)
{
...
void xwii::accel_show_ext_z(double val)
{
	if (val < -5) {
		mvprintw(1, 91, "/\\");
		mvprintw(2, 91, "||");
...
void xwii::accel_show_ext(const struct xwii_event *event)
{
	double val;
...
void xwii::accel_show(const struct xwii_event *event)
{
...
void xwii::ir_show_ext(const struct xwii_event *event)
{
	double v;
...
void xwii::ir_show(const struct xwii_event *event)
{
...
bool xwii::mp_do_refresh;

void xwii::mp_show(const struct xwii_event *event)
{
	static int32_t mp_x, mp_y;
...
void xwii::mp_normalization_toggle(void)
{
...
void xwii::nunchuk_show_ext_x(double val)
{
	if (val < -10)
		mvprintw(30, 2, "<=========##          ");
	else if (val < -9)
...
void xwii::nunchuk_show_ext_y(double val)
{
...
void xwii::nunchuk_show_ext_z(double val)
{
	if (val < -5) {
		mvprintw(25, 12, "/\\");
		mvprintw(26, 12, "||");
...
void xwii::nunchuk_show_ext(const struct xwii_event *event)
{
	double val;
	const char *str = " ";
	int32_t v;
...
void xwii::bboard_show_ext(const struct xwii_event *event)
{
	uint16_t w, x, y, z;
...
void xwii::pro_show_ext(const struct xwii_event *event)
{
...
void xwii::classic_show_ext(const struct xwii_event *event)
{
	struct xwii_event ev;
	int32_t v;
	const char *str;
...
void xwii::classic_clear(void)
{
	/* forward to pro handler */
	pro_clear();
}

void xwii::classic_toggle(void)
{
	int ret;
...
/* guitar */
void xwii::guit_show_ext(const struct xwii_event *event)
{
	uint16_t code = event->v.key.code;
	bool pressed = event->v.key.state;
	int32_t v;
...
/* guitar hero drums */
void xwii::drums_show_ext(const struct xwii_event *event)
{
	uint16_t code = event->v.key.code;
	bool pressed = event->v.key.state;
	int32_t v;
...
void xwii::rumble_show(bool on)
{
	mvprintw(1, 21, on ? "RUMBLE" : "      ");
}

void xwii::rumble_toggle(void)
{
...
/* LEDs */
void xwii::led_show(int n, bool on)
{
	mvprintw(5, 59 + n*5, on ? "(#%i)" : " -%i ", n+1);
}

void xwii::led_toggle(int n)
{
	int ret;
...
void xwii::battery_show(uint8_t capacity)
{
	int i;
...
void xwii::battery_refresh(void)
{
	int ret;
	uint8_t capacity;
...
void xwii::devtype_refresh(void)
{
	int ret;
	char *name;
...
void xwii::extension_refresh(void)
{
	int ret;
	char *name;
...
void xwii::setup_ext_window(void)
{
	size_t i;
...
int xwii::run_iface(struct xwii_iface *iface)
{
