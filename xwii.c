...
static void xwii::print_info(const char *format, ...)
{
	va_list list;
	char str[58 + 1];
...
static void xwii::print_error(const char *format, ...)
{
	va_list list;
	char str[58 + 80 + 1];
...
static void xwii::key_show(const struct xwii_event *event)
{
...
static void xwii::key_clear(void)
{
...
static void xwii::key_toggle(void)
{
	int ret;
...
static void xwii::accel_show_ext_x(double val)
{
	if (val < -10)
		mvprintw(6, 81, "<=========##          ");
	else if (val < -9)
...
static void xwii::accel_show_ext_y(double val)
{
...
static void xwii::accel_show_ext_z(double val)
{
	if (val < -5) {
		mvprintw(1, 91, "/\\");
		mvprintw(2, 91, "||");
...
static void xwii::accel_show_ext(const struct xwii_event *event)
{
	double val;
...
static void xwii::accel_show(const struct xwii_event *event)
{
...
static void xwii::accel_clear(void)
{
	struct xwii_event ev;
...
static void xwii::accel_toggle(void)
{
	int ret;
...
static void xwii::ir_show_ext(const struct xwii_event *event)
{
	double v;
...
static void xwii::ir_show(const struct xwii_event *event)
{
...
static void xwii::ir_clear(void)
{
	struct xwii_event ev;
...
static void xwii::ir_toggle(void)
{
	int ret;
...
static bool xwii::mp_do_refresh;

static void xwii::mp_show(const struct xwii_event *event)
{
	static int32_t mp_x, mp_y;
...
static void xwii::mp_clear(void)
{
	struct xwii_event ev;
...
static void xwii::mp_toggle(void)
{
	int ret;
...
static void xwii::mp_normalization_toggle(void)
{
...
static void xwii::mp_refresh(void)
{
	mp_do_refresh = true;
}
...
static void xwii::nunchuk_show_ext_x(double val)
{
	if (val < -10)
		mvprintw(30, 2, "<=========##          ");
	else if (val < -9)
...
static void xwii::nunchuk_show_ext_y(double val)
{
...
static void xwii::nunchuk_show_ext_z(double val)
{
	if (val < -5) {
		mvprintw(25, 12, "/\\");
		mvprintw(26, 12, "||");
...
static void xwii::nunchuk_show_ext(const struct xwii_event *event)
{
	double val;
	const char *str = " ";
	int32_t v;
...
static void xwii::nunchuk_clear(void)
{
	struct xwii_event ev;
...
static void xwii::nunchuk_toggle(void)
{
	int ret;
...
static void xwii::bboard_show_ext(const struct xwii_event *event)
{
	uint16_t w, x, y, z;
...
static void xwii::bboard_clear(void)
{
	struct xwii_event ev;
...
static void xwii::bboard_toggle(void)
{
	int ret;
...
static void xwii::pro_show_ext(const struct xwii_event *event)
{
...
static void xwii::pro_clear(void)
{
	struct xwii_event ev;
	unsigned int i;
...
static void xwii::pro_toggle(void)
{
	int ret;
...
static void xwii::classic_show_ext(const struct xwii_event *event)
{
	struct xwii_event ev;
	int32_t v;
	const char *str;
...
static void xwii::classic_clear(void)
{
	/* forward to pro handler */
	pro_clear();
}

static void xwii::classic_toggle(void)
{
	int ret;
...
/* guitar */
static void xwii::guit_show_ext(const struct xwii_event *event)
{
	uint16_t code = event->v.key.code;
	bool pressed = event->v.key.state;
	int32_t v;
...
static void xwii::guit_clear(void)
{
	struct xwii_event ev;
	unsigned int i;
...
static void xwii::guit_toggle(void)
{
	int ret;
...
/* guitar hero drums */
static void xwii::drums_show_ext(const struct xwii_event *event)
{
	uint16_t code = event->v.key.code;
	bool pressed = event->v.key.state;
	int32_t v;
...
static void xwii::drums_clear(void)
{
	struct xwii_event ev;
	unsigned int i;
...
static void xwii::drums_toggle(void)
{
	int ret;
...
static void xwii::rumble_show(bool on)
{
	mvprintw(1, 21, on ? "RUMBLE" : "      ");
}

static void xwii::rumble_toggle(void)
{
	static bool on = false;
	int ret;
...
static bool xwii::led_state[4];

static void xwii::led_show(int n, bool on)
{
	mvprintw(5, 59 + n*5, on ? "(#%i)" : " -%i ", n+1);
}

static void xwii::led_toggle(int n)
{
	int ret;
...
static void xwii::led_refresh(int n)
{
	int ret;
...
static void xwii::battery_show(uint8_t capacity)
{
	int i;
...
static void xwii::battery_refresh(void)
{
	int ret;
	uint8_t capacity;
...
static void xwii::devtype_refresh(void)
{
	int ret;
	char *name;
...
static void xwii::extension_refresh(void)
{
	int ret;
	char *name;
...
static void xwii::refresh_all(void)
{
	battery_refresh();
	led_refresh(0);
	led_refresh(1);
...
static void xwii::setup_window(void)
{
	size_t i;
...
static void xwii::setup_ext_window(void)
{
	size_t i;
...
static void xwii::handle_resize(void)
{
	if (LINES < 24 || COLS < 80) {
		mode = MODE_ERROR;
		erase();
...
static void xwii::handle_watch(void)
{
	static unsigned int num;
	int ret;
...
static void xwii::freeze_toggle(void)
{
	freeze = !freeze;
	print_info("Info: %sreeze screen", freeze ? "F" : "Unf");
}

static int xwii::keyboard(void)
{
	int key;
...
static int xwii::run_iface(struct xwii_iface *iface)
{
...
static char *xwii::get_dev(int num)
{
	struct xwii_monitor *mon;
	char *ent;
	int i = 0;
...
int main(int argc, char **argv)
{
	...
	if (argc < 2 || !strcmp(argv[1], "-h")) {
		...
		cxwii->ret = cxwii->enumerate();
		printf("End of device list\n");
	} else {
		if (argv[1][0] != '/')
			cxwii->path = cxwii->get_dev(atoi(argv[1]));

		cxwii->ret = cxwii->xwii_iface_new(&iface, path ? path : argv[1]);
		free(cxwii->path);
		if (cxwii->ret) {
			...
			cxwii->ret = cxwii->xwii_iface_open(iface,
					      cxwii->xwii_iface_available(iface) |
					      XWII_IFACE_WRITABLE);
			if (cxwii->ret)
				print_error("Error: Cannot open interface: %d",
					    cxwii->ret);

			cxwii->ret = cxwii->run_iface(cxwii->iface);
			cxwii->xwii_iface_unref(cxwii->iface);
			if (cxwii->ret) {
